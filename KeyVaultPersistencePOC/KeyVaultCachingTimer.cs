...
{
    public static class KeyVaultCachingTimer
    {
        /// <summary>
        ...
        [FunctionName("KeyVaultCachingTimer")]
        public static async void Run([TimerTrigger("0 */20 * * * *")]TimerInfo myTimer, TraceWriter log)
        {
