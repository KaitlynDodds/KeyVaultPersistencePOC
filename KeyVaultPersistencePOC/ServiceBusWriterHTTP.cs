...
{
    public static class ServiceBusWriterHTTP
    {

        // cache
        static MemoryCache memoryCache = MemoryCache.Default;

        [FunctionName("ServiceBusWriterHTTP")]
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            ...
            if (primaryKey == null || secondaryKey == null)
            {
                ...
                return req.CreateErrorResponse(HttpStatusCode.BadRequest, "Secret values not found.");
            }
